...
public class Case_functions {
    ...
    private ArrayList<Case> copyObjectFromFile() {
        ...
        ArrayList<String[]> data = dbms.read("Cases.csv");

        for (String[] line : data) {
            try{
                String[] evid = line[3].split(" ");
                String[] peid = line[5].split(" ");
                ArrayList<Integer> evidence_id = new ArrayList<>();
                ArrayList<Integer> people_id = new ArrayList<>();
                for (String s : evid) {
                ...
                Case CaseObject = new Case(Integer.valueOf(line[0]), line[1], line[2], evidence_id, line[4], people_id);
