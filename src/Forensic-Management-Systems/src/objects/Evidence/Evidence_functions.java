...
public class Evidence_functions {
    ...
    private void write(ArrayList<Evidence> Evidences) {
    ...
    private ArrayList<Evidence> copyObjectFromFile() {
        ...
        ArrayList<String[]> raw_Evidence = dbms.read("Evidences.csv");
        
        for (String[] raw : raw_Evidence) {
            int evidenceid = Integer.parseInt(raw[0]);
            String evidencename = raw[1];
            String evidencedescription = raw[2];
            String evidencetype = raw[3];
            String timeofcollection = raw[4];
            String dateofcollection = raw[5];
            String placeofcollection = raw[6];
            String collectedby = raw[7];
            String addedby = raw[8];
            Evidences.add(new Evidence(evidenceid,evidencename,evidencedescription,evidencetype,timeofcollection,dateofcollection,placeofcollection,collectedby,addedby));
        }
